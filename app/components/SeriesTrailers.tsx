    ...
    <div className="cast-container w-full h-auto mt-6">
      ...
      >
        {trailers.results.slice(0, 1).map((trailer: any) => (
          <div
            key={trailer.id}
            className="w-[400px] sm:w-[50vw] h-[240px] sm:h-[100px] rounded-xl sm:rounded-lg overflow-hidden relative"
            style={{
          ...
          >
            <div className="mask absolute top-0 left-0 w-full h-[100%] bg-[#0000008d] flex items-center justify-center">
        ...
        >
          <div
            style={{ flex: "0 0 auto" }}
            className="w-[400px] sm:w-[50vw] h-[240px] sm:h-[100px] rounded-xl sm:rounded-lg bg-gray-900 flex justify-center items-center cursor-pointer"
          >
